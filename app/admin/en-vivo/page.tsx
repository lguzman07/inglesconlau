...
export const metadata: Metadata = {
  ...
  description: 'Configura la sala de video y el Canva de la clase en vivo.',
};
    ...
    <main className={styles.page}>
      <div className={styles.container}>
        ...
        <header className={styles.header}>
          ...
          <h1>Clase en vivo</h1>
          <p>
            Configura el salón de Whereby y el diseño de Canva que verán tus estudiantes en{' '}
            <code>/clase-en-vivo</code>. Actualiza el link de Canva antes de cada clase y abre el
            salón cuando estés lista para empezar.
          </p>
        </header>
        {error || !settings ? (
