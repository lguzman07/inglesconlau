      ...
      <div className={styles.container}>
        ...
        <section className={styles.heading} aria-labelledby="lesson-title">
          <div>
            ...
            <h1 id="lesson-title">Lección {lessonNumber}</h1>
            <p className={styles.description}>
              Esta página será tu guía completa: video, práctica y avance de la
              lección en un mismo lugar.
            </p>
          </div>
        ...
        <section className={styles.videoSection} aria-labelledby="video-heading">
          <div className={styles.videoPlaceholder}>
            ...
            <span>Cuando grabes esta lección, añadiremos el video en este espacio.</span>
          </div>

          <div className={styles.videoDetails}>
            <p className={styles.eyebrow}>VIDEO DE LA LECCIÓN</p>
            <h2 id="video-heading">Aprende paso a paso</h2>
            <p>
              Aquí explicarás el tema con ejemplos claros. Las estudiantes podrán
              pausar, volver a ver el video y seguir a su propio ritmo.
            </p>
          </div>
        </section>

        <section className={styles.objectiveCard} aria-labelledby="objective-heading">
          <div className={styles.objectiveIcon} aria-hidden="true">◎</div>
          <div>
            <p className={styles.eyebrow}>OBJETIVO</p>
            <h2 id="objective-heading">Lo que lograrás en esta lección</h2>
            <p>
              Añadiremos el objetivo específico cuando definamos el contenido de
              esta lección.
            </p>
          </div>
        </section>

        <section className={styles.practiceSection} aria-labelledby="practice-heading">
        ...
        <section className={styles.completionCard}>
          <div>
            ...
            <h2>Cuando termines, podrás marcar esta lección como completada.</h2>
            <p>Conectaremos este botón al progreso guardado de cada estudiante.</p>
          </div>
        ...
        <nav className={styles.lessonNavigation} aria-label="Navegación entre lecciones">
          {previousLesson ? (
            <Link href={`/lecciones/${nivel}/${previousLesson}`} className={styles.navigationLink}>
              <span>← Anterior</span>
          ...
          {nextLesson ? (
            <Link href={`/lecciones/${nivel}/${nextLesson}`} className={styles.navigationLink}>
              <span>Siguiente →</span>
              <strong>Lección {nextLesson}</strong>
            </Link>
          ) : (
            <Link href={`/lecciones/${nivel}`} className={styles.navigationLink}>
