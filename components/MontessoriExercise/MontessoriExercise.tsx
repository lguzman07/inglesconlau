...
function getCorrectPlacement(
  ...
  const placements =
    question.correctPlacements as unknown;
                        ...
                        return (
                          ...
                          >
                            ...
                            <VocabularyButton
                              ...
                              exampleSentence={question.words
                                .map(
                                  (
                                    item,
                                  ) =>
