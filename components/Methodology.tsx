    ...
    >
      ...
      >
        <div>
          ...
          >
            <p>
              Aprendí inglés de una manera bastante inusual. Sí, tomé clases,
              pero la mayoría de lo aprendido fue a través de métodos que muchos
              no considerarían tradicionales: escuchar música, ver series,
              películas, hablar con mis amigos con el mucho o poco inglés que
              supiéramos… Verás, al aprenderlo desde niña tuve una ventaja
              bastante significativa. Los niños son como esponjas: lo absorben
              todo. Es por eso que es tan común escuchar: “ponlo desde chiquito
              en clases que así aprende más fácil”.
            </p>
            ...
            <p>
              ...
              qué aprender y qué no aprender. Claro, en muchos de los casos
              quizás sí nos veamos forzados a aprender el idioma: porque sabemos
              que con el inglés tendremos más oportunidades laborales, porque
              nuestro trabajo actual lo requiere para poder seguir escalando,
              en fin. Un sinnúmero de razones, todas buenas y válidas, para
              aprenderlo.
            </p>

            <p>
              Dicho esto, quiero expresarte por qué me apasiona tanto enseñar y
            ...
            <table style={tableStyle}>
              <thead>
                <tr style={{ background: 'var(--primary-light)' }}>
                  <th style={tableHeaderStyle}>Español</th>
                  <th style={tableHeaderStyle}>Inglés</th>
                </tr>
              </thead>
              ...
              <tbody>
                {[
                  ...
                  >
                    <td style={tableCellStyle}>{es}</td>
                    <td style={englishCellStyle}>{en}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <p>
              <strong>NO lo estarías aprendiendo desde cero.</strong> El español
              y el inglés tienen un sinnúmero de similitudes,{' '}
            ...
            <p>
              <strong>
                ¡Acompáñame en este viaje que es el aprendizaje y permíteme
      ...
      >
        ...
        >
          ...
          <span style={{ color: 'var(--primary)' }}> el español.</span>&rdquo;
        </h3>
      </div>
    </section>
  );
