...
const faqs = [
  ...
  { question: '¿Qué incluye la suscripción?', answer: 'Con tu suscripción tendrás acceso a lecciones grabadas en video, ejercicios interactivos, visualización de tu progreso y una ruta de aprendizaje.' },
  { question: '¿Las clases son en vivo, grabadas o ambas?', answer: 'Las lecciones son grabadas para que puedas verlas cuando quieras, repetir mis explicaciones y estudiar a tu propio ritmo.' },
